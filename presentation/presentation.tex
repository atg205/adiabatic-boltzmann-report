...
\title{Toward Quantum Competitiveness in Adiabatic Quantum Computing: A Comparative Study of Variational Algorithms}
\date{}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=south east, xshift=-3.4cm, yshift=0.5cm, fill=white, rounded corners=2pt, inner sep=2pt] at (current page.south east) {\includegraphics[height=1cm]{../figures/logo/iitislogo.png}};
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}
    ...
    \node[anchor=north west, inner sep=0pt] (map) at (0,0) {\includegraphics[width=\PolandWcm cm]{../figures/Poland_adm_location_map.pdf}};
...
\end{block}
\begin{itemize}
    \item will come back to this later when talking about Quantum Annealing ;)
\end{itemize}
...
\end{itemize}
\begin{block}{Time-to-$\epsilon$, 99\% confidence}
\begin{equation*}
\mathrm{TTE}_{99} =
\begin{cases}
T_r, & p = 1, \\[2pt]
...
\begin{frame}{TTE results}
\centering
\includegraphics[width=0.9\linewidth]{../figures/fig10c_tte99_vs_n_eps0.1.pdf}

\vspace{0.3cm}
Pegasus and Zephyr (+CEM) overtake FPGA by the largest system size tested
\end{frame}

\begin{frame}{Energy consumption results}
\centering
\includegraphics[width=0.6\linewidth]{../figures/fig10d_energy99_vs_n_eps0.1.pdf}

\vspace{0.3cm}
FPGA is the fastest and most energy-efficient of the metered classical solvers
\end{frame}
