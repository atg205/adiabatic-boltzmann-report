...
Gibbs sampling can be considered a special case of the Metropolis-Hastings algorithm. It is used when sampling from the joint probability distribution is impractical, but sampling from the conditional distribution is possible.
